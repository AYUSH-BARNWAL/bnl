...
const MemberPage = () => {
  ...
  useEffect(() => {
    ...
    if (formState?.info) {
      toast.info(formState.info);
    }
    if (formState?.success) {
      toast.success("Member created successfully");
      for (let key in formState){
        console.log(JSON.parse(formState[key]))
      }
              ...
              <div className="flex flex-row gap-24">
                <div className="flex flex-col w-2/5">
                  <Input
                    ...
                    classNames={{
                      label:
                        "font-bold text-lg text-gray-700 whitespace-nowrap",
                      inputWrapper:
                ...
                <div className="flex  w-2/5">
                  <RadioGroup
                    ...
                    classNames={{
                      label:
                        "font-bold text-lg whitespace-nowrap text-gray-700",
                    }}
                    defaultValue="mr"
                  >
